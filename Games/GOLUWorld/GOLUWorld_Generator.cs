    ...
    internal static void Generator_World(T_World World){
        void GenerateCalm(uint Seed){
            ...
            Generator_SandPatch(Seed);
                        ...
                        Generator_Structure(0, 0, new Structure(@"................................................................
................................................................
................................................................
................................................................
................................................................
...
................................................................"), Replace: true);
    ...
    /// </summary>
    internal static void Generator_Structure(int X, int Y, Structure S, uint __Seed = 0, bool ToCenter = true, bool Replace = false){
        int OffsetX = X;
        int OffsetY = Y;
        if(ToCenter){
        ...
        if(!string.IsNullOrWhiteSpace(S.Blocks  )){ World_AddBlocksMap  (S.Blocks  , OffsetX, OffsetY, __Seed, Replace); }
        if(!string.IsNullOrWhiteSpace(S.Entities)){ World_AddEntitiesMap(S.Entities, OffsetX, OffsetY, __Seed); }
        if(!string.IsNullOrWhiteSpace(S.Ceilings)){ World_AddCeilingsMap(S.Ceilings, OffsetX, OffsetY, __Seed, Replace); }
    }
